...
<div class="wpc-bar-progress<?php if ($loading) echo ' wpc-bar-loading wpc-graph-loading wpc-loading'; ?> wpc-rounded <?php echo esc_attr($this->get_course_class($atts)); ?>"<?php if (!$loading) echo ' data-progress="' . esc_attr($percentage) . '"'; ?>>
  <div class="wpc-progress-bar">
    <div class="wpc-progress-track">
      <div class="wpc-progress-fill"></div>
